...
<head>
    ...
    <title>Iniciar Sesion | Lamborghini</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <form method="post" action="IniciarSES.php" class="form">
                    ...
                    <div>
                        <input type="submit" class="btn btn-primary enviar" value="Iniciar sesion">
